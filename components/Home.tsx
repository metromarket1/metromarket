...
import { Step1MealSelection } from './Step1MealSelection';
import { Step2DetailsReview } from './Step2DetailsReview';
import { Cart, MenuItem, UserDetails, OrderData, CartItem, MenuAvailability } from '../types';
import { submitOrderToFirebase, subscribeToMenuAvailability } from '../services/firebase';
...
export const Home: React.FC = () => {
  ...
  // Subscribe to Menu Availability
  useEffect(() => {
    const unsubscribe = subscribeToMenuAvailability((data) => {
